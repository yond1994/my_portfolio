                    ...
                    <div class="col-md-12 col-lg-8 col-lg-offset-2">
                        <div class="widget">
                            <header class="widget-header">
                                <h4 class="widget-title">Editar trabajo</h4>
                            ...
                            <div class="widget-body">
                                ...
                                <form method="POST" action="{{url('admin/work/'.$data->id)}}">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="title" value="{{$data->name}}" class="form-control" id="title" placeholder="Título de la prueba...">
                                    </div>
                                    <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="url" class="form-control" id="url" value="{{$data->link}}" placeholder="Url...">
                                    </div>
                                    <div class="form-group">
                                ...
                                <form action="{{url('admin/work/'.$data->id)}}" method="POST">
                                    {{ method_field('DELETE') }}
                                    {{ csrf_field() }}
