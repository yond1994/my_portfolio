                    ...
                    <tr>
                        <td align="center" valign="top">
                            ...
                            <table style="margin: 0 auto;" cellpadding="0" cellspacing="0" class="force-full-width" bgcolor="#4dbfbf">
                                ...
                                <tr>
                                    <td class="headline">
                                        Ey <i>{{$from}} gracias por contactarnos.</i>
                                    </td>
                                </tr>
                                <tr>
                                    <td>
                                        ...
                                        <center>
                                            <table style="margin: 0 auto;" cellpadding="0" cellspacing="0" width="60%">
                                                <tr>
                                                    <td style="color:#fff;">
                                                        <br>
                                                        Estaremos en contacto en la brevedad posible. <br><br>
                                                        <br>
                                                        <br>
                                                    </td>
                                                </tr>
                            ...
                            <table style="margin: 0 auto;" cellpadding="0" cellspacing="0" class="force-full-width" bgcolor="#414141" style="margin: 0 auto">
                                <tr>
                                    <td style="background-color:#414141;">
                                        <br>
                                        <br>
                                         <a href="https://www.facebook.com/yonathan.suarez.583" target="_blank"><img src="https://www.filepicker.io/api/file/cvmSPOdlRaWQZnKFnBGt" alt="facebook"></a>
                                     <a href="https://www.youtube.com/channel/UCbLCjrhCC1jl68lxNbSHw0g/featured" target="_blank"><img style="width: 10%;" src="http://www.mymadisoncares.com/wp-content/uploads/2016/10/youtube-logo-vector-6.png" alt="youtube"></a>
                                        <br>
                                        <br>
                                    </td>
                                </tr>
