                    ...
                    <div class="col-md-3 col-sm-6">
                        <div class="widget stats-widget">
                            <div class="widget-body clearfix">
                                <div class="pull-left">
                                    <h3 class="widget-title text-primary"><span class="counter" data-plugin="counterUp">66.136</span></h3>
                                </div>
                ...
                <div class="wrap p-t-0">
                    <footer class="app-footer">
                        <div class="clearfix">
                            ...
                            <div class="copyright pull-left">Copyright RaThemes 2019 &copy;</div>
                        </div>
                    </footer>
                </div>
                <!-- /#app-footer -->
